...
import { ArrowRight, Bot, CheckCircle2, Image, ShieldCheck, Target } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <section className="relative min-h-[76vh] overflow-hidden flex flex-col">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-5 md:px-12 lg:px-20">
          ...
          <button type="button" onClick={onAccess} className="rounded-lg border border-white/20 bg-white/10 px-4 py-2 text-xs font-bold backdrop-blur hover:bg-white/15">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-3 md:grid-cols-4">
          {workflow.map(([Icon, label], index) => (
            <div key={label} className="relative rounded-xl border border-slate-800 bg-slate-900 p-5">
        ...
        <div className="mt-14 grid gap-6 border-t border-slate-800 pt-10 md:grid-cols-[1fr_2fr]">
